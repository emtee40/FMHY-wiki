...
- [Stream Aggregators](https://github.com/fmhy/FMHY/wiki/Stream-Site-Grading#stream-aggregators)
...
1. Site looks good + works well on mobile. ✔️
1. Site does have a custom player (added features to movie-web). ✔️
...
1. Sites UI is good, feels modern and unique. ✔️
1. The site has watch lists + history, and you can login to sync them across devices. ✔️
1. Site has good sorting + collections, but could use a bit more in terms of discovery options. 🟡
1. Site is free from new tab/window popup ads, can be used without an adblocker. ✔️
1. Site looks good + works well on mobile. ✔️
1. Site does not have a custom player. ❌
1. Site does not have watch parties. ❌
...
1. The site has watch lists and you can login to sync them across devices. ✔️
1. Site has good sorting options + platform page. ✔️
1. Site has constant new tab/window popups, difficult/impossible to use without adblocker. ❌
1. Site looks good + works well on mobile. ✔️
1. Site does not have a custom player. ❌
1. Site does not have watch parties. ❌
...
### Score: 9/20
1. Has movies, TV, anime, 1080p, adjustable quality, and subtitles. ✔️
1. 4 servers but does not auto-switch if ones fails. ❌
1. Site does have episode auto-next on some servers. 🟡
