...
**Note** - We will likely add categories for mobile optimization, intro skip, cross platform watchlist sync, & more in the future.
...
1. Site does not have episode auto-next. ✔️
...
1. Has AI recommendation tool, but it only gives 1 movie, more discoverability options could be added. ❌
1. Site does not have 4K content. ❌
