...
Add `https://vd-plugins.github.io/web/` in plugins section of bunny for a plugin browser. Many of these plugins are broken and cannot be enabled, so look in revenge discord server plugins channel for fixed versions.
