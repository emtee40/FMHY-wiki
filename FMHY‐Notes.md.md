...
If it's currently closed and you want to send us a link, feel free to do any of the following: 

* Send it to our [feedback system](https://i.ibb.co/yRyVsXT/image.png) at the top of every FMHY section on our [site](https://fmhy.net/).
* Send us a [message](https://www.reddit.com/message/compose/?to=/r/FREEMEDIAHECKYEAH) on Reddit.
* Send an [issue](https://github.com/fmhy/edit/issues) or [pull request](https://github.com/fmhy/edit/pulls) to our GitHub.
...
You can also [enable an extension](https://pstream.org/onboarding/extension) / [2](https://github.com/sussy-code/browser-ext/releases/) that will add more sources, but it requires permissions that are somewhat excessive, and the site works fine without it. The extension is safe, and many people use it, the permissions are just needed in order for the [extension to work correctly](https://rentry.co/htagcrv4). 
